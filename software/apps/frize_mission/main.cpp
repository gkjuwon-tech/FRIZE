...
int main(int argc,char**argv){
    ...
    // ── 에이전트: 드론 3대(층별) + 대원 1명 ──
    std::vector<Agent> ag;
    ag.push_back({"SCOUT-1","scout", mkpath({ // 1층 정찰
        {8,-2,1.6f},{8,1.0f,1.6f},{3.5f,2.5f,1.7f},{4,5,1.7f},{12,2.5f,1.8f},{17,3.0f,1.8f},
        {17,7.4f,1.9f},{10,7.4f,1.9f},{3,7.4f,1.9f},{2.5f,11,1.9f},{8,11.5f,2.0f},{17.5f,11,2.0f},{12,7.4f,1.9f}
    },0.5f,true), drone_lidar(1)});
    ag.push_back({"SCOUT-2","scout", mkpath({ // 계단→2층 정찰(우화점)
        {8,-1.5f,1.5f},{2.0f,2.5f,1.6f},{1.5f,2.5f,3.0f},{1.5f,2.5f,4.8f},{4,4,4.9f},{10,7.4f,4.9f},
        {17,3.0f,4.9f},{17,11,5.0f},{15,11,5.0f},{14.5f,10.5f,4.6f},{6,11,5.0f},{3,5,5.0f}
    },0.5f,true), drone_lidar(7)});
    ag.push_back({"SCOUT-3","scout", mkpath({ // 3층 정찰(요구조자2)
        {8,-1.0f,1.5f},{2,2.5f,1.6f},{1.5f,2.5f,5.2f},{1.5f,2.5f,8.1f},{3,12.3f,8.1f},{2.8f,12.4f,7.0f},
        {8,11,8.1f},{16,11,8.1f},{16,3,8.1f},{8,7.4f,8.1f},{3,3,8.1f}
    },0.5f,true), drone_lidar(13)});
    ag.push_back({"VISOR-1","visor", mkpath({ // 대원 도보(1층 → 요구조자1)
        {8,-1.5f,1.5f},{8,1.5f,1.5f},{4,3,1.5f},{3.5f,5.5f,1.5f},{8,7.4f,1.5f},{15,7.4f,1.5f},
        {17.2f,3.2f,1.5f},{17.4f,3.0f,1.5f},{15,7.4f,1.5f},{8,7.4f,1.5f}
